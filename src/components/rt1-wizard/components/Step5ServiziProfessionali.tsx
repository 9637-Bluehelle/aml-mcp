...
export function Step5ServiziProfessionali({ risposta, updateRisposta, isReadOnly }: Step5Props) {
  const sezione = SEZIONI_WIZARD.find(s => s.key === 'servizi_professionali_offerti')!;
