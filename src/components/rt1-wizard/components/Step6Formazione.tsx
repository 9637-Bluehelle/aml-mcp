...
export function Step6Formazione({ risposta, updateRisposta, isReadOnly }: Step6Props) {
  const sezione = SEZIONI_WIZARD.find(s => s.key === 'formazione')!;
    ...
    <Card>
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Aggiungi eventuali note sui corsi di formazione effettuati, frequenza, argomenti trattati..."
        />
      </div>
    </Card>
  );
