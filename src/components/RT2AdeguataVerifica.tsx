...
import { loadImpostazioni, generateCodiceIncarico, type FormatoCodiceIncarico } from '../lib/codiceGenerator';
...
export function RT2AdeguataVerifica({ onNavigate }: { onNavigate?: (tab: string) => void } = {}) {//| 'new-cliente'
  ...
  */
  ...
  const [formatoIncarico, setFormatoIncarico] = useState<FormatoCodiceIncarico>('manuale');
  useEffect(() => {
